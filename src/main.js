...
submitBtn.addEventListener("click", async function() {
    ...
    const url = `http://api.openweathermap.org/geo/1.0/direct?q=${cityName.value},${countryName.value}&limit=5&appid=52d52348ea3386cb085d4fd967aa0834`;
    let lat = 0
    let long = 0
...
async function getWeatherData(lat, long) {
    const url = `http://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${long}&units=metric&appid=52d52348ea3386cb085d4fd967aa0834`;
